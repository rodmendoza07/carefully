...
, (1, 9, '<div class="text-justify">Una vez agendes tu cita, debes tomar en cuenta que solo podrás cancelarla 12 horas antes del horario de tu sesión, de lo contrario no la podrás recuperar.</div>', 1)
, (1, 10, '<div class="text-justify">Recuerda que el horario que elijes para tu sesión en la AGENDA siempre corresponde al huso horario de la CDMX, por lo que si agendas tu cita a las 10.00 am, tu cita será a las 10.00am de la Ciudad de México. Si estás en otro estado o país, deberás tomar en cuenta la diferencia horaria.</div>', 1)
, (1, 11, '<div class="text-justify">Puedes agendar tantas citas como hayas pagado, sin embargo, te recomendamos estar muy al pendiente porque los horarios de tu terapeuta pueden variar cada semana y las citas pueden ser reprogramadas.</div>', 1)
, (1, 12, '<div class="text-justify">Sí, siempre que tu terapeuta tenga el espacio disponible. Sin embargo esto no es recomendable en la mayoría de los tratamientos.</div>', 1)
, (1, 13, '<div class="text-justify">Mi TERAPIA recoge información de tus sesiones para que lleves un registro de las mismas. Tanto de las sesiones que ya recibiste, como las que están agendadas y próximas a tomar. Podrás observar fecha de tu sesión, horario elegido, nombre de tu terapeuta y el estatus de tu cita.</div>', 2)
, (1, 14, '<div class="text-justify">MI TERAPEUTA recoge un resumen de la información profesional de tu especialista. Su  nombre,  nacionalidad, estudios, experiencia profesional y una breve presentación para que lo conozcas un poco más.</div>', 3)
, (1, 15, '<div class="text-justify">En esta sección se recogen los datos que rellenaste en el cuestionario inicial. Además podrás  completar o modificar la información que quieras que tu terapeuta reciba sobre tus datos personales.</div>', 4)
, (1, 16, '<div class="text-justify">No es obligatorio, pero si necesario que rellenes algunos datos personales básicos para que tu terapeuta tenga la información mínima necesaria sobre ti. Entre más información rellenes, mayor información tendrá y en consecuencia más sabrá de ti y de tu problema.</div>', 4)
, (1, 17, '<div class="text-justify">Solo tú y tu terapeuta.</div>', 4)
, (1, 18, '<div class="text-justify">Es la información de tu caso que tu terapeuta comparte contigo. Además de ésta información tu terapeuta elabora un expediente mucho más complejo y completo para poder dar seguimiento a tu caso.</div>', 4)
, (1, 19, '<div class="text-justify">Para nada, tanto en el caso de derivaciones, como si quisieras cambiar de terapeuta, toda tu información personal y clínica se envía al nuevo terapeuta, para que esté completamente informado y al día con tu progreso.</div>', 4)
, (1, 20, '<div class="text-justify">Muy sencillo, en la sección de mi perfil solo debes hacer click en "editar" y ahí podrás modificar tu información en el caso de que existiera algún error en la misma.</div>', 4)
, (1, 21, '<div class="text-justify">En esta sección puedes visualizar toda la información referente a los pagos realizados, fecha, hora, descripción de pago, así como el número de sesiones y el monto total del cargo.<br><br>También puedes comprar sesiones y canjear códigos de descuento.</div>', 5)
, (1, 22, '<div class="text-justify">Los códigos de descuento los puedes conseguir a través de ofertas que llegan a tu correo, promociones en nuestras redes sociales o compras de regalos que puedes encontrar en la sección de “Regala felicidad”</div>', 5)
, (1, 23, '<div class="text-justify">Solamente tienes que dirigirte a la sección de CRÉDITO e introducir tu código en el recuadro de la izquierda, posteriormente solo debes hacer click en Canjear.</div>', 5)
, (1, 24, '<div class="text-justify">En el caso que existiera algún problema en el funcionamiento de tu sesión puedes reportarlo en esta sección, así mismo puedes consultar los reportes que ya hayas realizado y el estatus de los mismos.</div>', 6)
, (1, 25, '<div class="text-justify">Esto dependerá del tipo de problema, sin embargo suele realizarse a la brevedad. En caso de que hayas enviado un reporte y tu problema no haya sido resuelto, puedes enviarnos un correo a soporte@cuidadosamnete.com</div>', 6)
, (1, 26, '<div class="text-justify">Las sesiones deben ser elegidas por el paciente dentro del horario que tú señales para su efecto.</div>', 7)
, (1, 27, '<div class="text-justify">Así es, una vez el paciente agende su cita, te llegará una solicitud o notificación que podrás visualizar en la campanita de arriba a la derecha. Podrás aceptar o rechazar la sesión. Recuerda que no puedes rechazar la sesión sin justificación previa.</div>', 7)
, (1, 28, '<div class="text-justify">Sólo puedes cancelar o rechazar una sesión si tienes una justificación de peso para hacerlo. Recuerda que como máximo podrás cancelar 3 sesiones al año, por lo que se te recomienda elegir bien los horarios que pones a disposición para tus citas y así  evitar cancelaciones.</div>', 7)
, (1, 29, '<div class="text-justify">En la parte baja izquierda de tu AGENDA puedes observar una leyenda con la interpretación de los colores de tus sesiones.<br><br><ul><li><span class="text-default">Color gris:</span><label>&nbsp;&nbsp;Espacio No disponible</label></li><li><span class="text-agendado">Color verde:</span><label>&nbsp;&nbsp;Sesión agendada</label></li><li><span class="text-enviado">Color azul:</span><label>&nbsp;&nbsp;Sesión enviada</label></li><li><span class="text-reprogramado">Color naranja:</span><label>&nbsp;&nbsp;Sesión reprogramada</label></li><li><span class="text-cancelado">Color rojo:</span><label>&nbsp;&nbsp;Sesión cancelada</label></li></ul></div>', 7)
, (1, 30, '<div class="text-justify">Sólo deberás conectarte el día de tu cita, 5-10 min antes de tu sesión y empezar con tu terapia.</div>', 7)
, (1, 31, '<div class="text-justify">Una vez tu paciente agende su cita, sólo podrá cancelarla hasta 12 horas antes del horario de vuestra sesión, de lo contrario, la sesión se dará por recibida.</div>', 7)
, (1, 32, '<div class="text-justify">Recuerda que el horario de la agenda siempre corresponde al huso horario de la CDMX, por lo que si tu cita es a las 10.00 am,  deberás estar preparada a las 9.50  am de la Ciudad de México. Si estás en otro estado o país, deberás tomar en cuenta la diferencia horaria.</div>', 7)
, (1, 33, '<div class="text-justify">Tu paciente puede agendar tantas citas como haya pagado, sin embargo, te recomendamos asesorarle en la periodicidad de sus citas.</div>', 7)
, (1, 34, '<div class="text-justify">Sí, siempre que tu tengas el espacio disponible. Sin embargo, te recomendamos asesorarle en la periodicidad de sus citas.</div>', 7)
, (1, 35, '<div class="text-justify">Mi TERAPIA recoge información de tus sesiones para que lleves un registro de las mismas. Tanto de las sesiones que ya recibieron tus pacientes, como las que están agendadas y próximas a tomar. Podrás observar fecha de tus sesiones, horario elegido por tus pacientes, los nombres de nombre de los mismos y el estatus de tus citas.</div>', 8)
, (1, 36, '<div class="text-justify">Ésta sección recoge un resumen de tu información personal y profesional. Tu nombre,  nacionalidad, estudios, experiencia profesional y una breve presentación que deberás realizar para que tus pacientes te conozcan mejor.</div>', 9)
, (1, 37, '<div class="text-justify">Si, ya que es necesario que tu paciente tenga la mayor información posible sobre tu carrera profesional y experiencia. Te recomendamos no poner información personal. Todo lo que escribas será validado antes de ser publicado por nuestro administrador.</div>', 9)
, (1, 38, '<div class="text-justify">El informe clínico del paciente recogerá información general sobre el caso y la problemática del mismo, así como su funcionamiento, aspectos médicos y perfil social entre otros.</div>', 10)
, (1, 39, '<div class="text-justify">Sí. Durante las dos primeras sesiones deberás rellenar la información básica de tu paciente. A lo largo del tratamiento irás completando con mayor información relevante.</div>', 10)
, (1, 40, '<div class="text-justify">Sólo podrás hacerlo en el caso de que no exista evolución o avance en la problemática del paciente, y siempre con previo aviso y consentimiento de Cuidadosamente.</div>', 10)
, (1, 41, '<div class="text-justify">Sí. Tu paciente puede decidir cambiar de terapeuta en el caso de que no se sienta cómodo en sus sesiones.</div>', 10)
, (1, 42, '<div class="text-justify">Cuando un paciente es derivado toda su información personal y clínica se envía al nuevo terapeuta, para que esté completamente informado y al día con su problemática y avance. Por lo tanto tendrás toda la información que necesites para retomar el caso.</div>', 10)
, (1, 43, '<div class="text-justify">En el caso que existiera algún problema en el funcionamiento de tu sesión puedes reportarlo en esta sección, así mismo puedes consultar los reportes que ya hayas realizado y el estatus de los mismos.</div>', 11)
, (1, 44, '<div class="text-justify">Esto dependerá del tipo de problema, sin embargo suele realizarse a la brevedad. En caso de que hayas enviado un reporte y tu problema no haya sido resuelto, puedes enviarnos un correo a soporte@cuidadosamnete.com</div>', 11);