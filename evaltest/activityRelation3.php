                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <input type="radio" name="" id=""> Un amigo o familiar
                            </div>
                        </div>
                    </div>
                    <div class="row pt-c">
                        <div class="col-md-12">
                            <div class="form-group">
                                <input type="radio" name="" id=""> Mi doctor
                            </div>
                        </div>
                    </div>
                    <div class="row pt-c">
                        <div class="col-md-12">
                            <div class="form-group">
                                <input type="radio" name="" id=""> Busqué in internet
                            </div>
                        </div>
                    </div>
                    <div class="row pt-c">
                        <div class="col-md-12">
                            <div class="form-group">
                                <input type="radio" name="" id=""> Vi un anuncio
                            </div>
                        </div>
                    </div>
                    <div class="row pt-c">
                        <div class="col-md-12">
                            <div class="form-group">
                                <input type="radio" name="" id=""> Redes sociales
                            </div>
                        </div>
                    </div>
                    <div class="row pt-c">
                        <div class="col-md-12">
                            <div class="form-group">
                                <input type="radio" name="" id=""> En un artículo
                            </div>
                        </div>
                    </div>
                    <div class="row pt-c">
                        <div class="col-md-12">
                            <div class="form-group">
                                <input type="radio" name="" id=""> Medios de comunicación (radio/tv)
                            </div>
                        </div>
                    </div>
                    <div class="row pt-c">
