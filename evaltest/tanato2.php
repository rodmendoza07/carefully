...
<head>
	...
	<style>
		body {
			background: url('resource/004.jpg');
		}
  	</style>
</head>
...
<body id="mimin" class="dashboard">
	...
	<!-- start: content -->
		<div id="content">
			...
			<div class="row">
				<div class="col-md-12">
					<h2 style="font-family:'Raleway-Bold'">¿QUÉ VÍNCULO O PARENTEZCO TENÍAS CON ESE SER QUERIDO?</h2>
				</div>
			</div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <input type="radio" name="" id=""> FAMILIAR
                            </div>
                        </div>
                    </div>
                    <div class="row pt-c">
                        <div class="col-md-12">
                            <div class="form-group">
                                <input type="radio" name="" id=""> PAREJA / CÓNYUGUE
                            </div>
                        </div>
                    </div>
                    <div class="row pt-c">
                        <div class="col-md-12">
                            <div class="form-group">
                                <input type="radio" name="" id=""> AMISTAD
                            </div>
                        </div>
                    </div>
                    <div class="row pt-c">
                        <div class="col-md-12">
                            <div class="form-group">
                                <input type="radio" name="" id=""> MASCOTA
                            </div>
                        </div>
                    </div>
				</div>
            ...
            <div class="row" style="margin-top:5%">
				...
				<div class="col-md-4 col-xs-3" style="margin-top:-20.5%; position:absolute;">
